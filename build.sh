...
apt install -y --no-install-recommends prosody lua-unbound lua-event lua-zlib lua-dbi-sqlite3 lua-dbi-postgresql lua-bitop ca-certificates ssl-cert sqlite3
